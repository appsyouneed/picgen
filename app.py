...
with gr.Blocks(css=css) as demo:
    ...
    group_prompts_dict = {
        "Double Oral Pleasure": "The man from the photo sits or stands while two women from the photo kneel on either side of him. The first woman from the photo has the man's penis fully deep in her mouth with her lips sealed around the shaft, throat visibly bulging. The second woman from the photo licks and kisses the base and the first woman's lips simultaneously. Both women's breasts are fully exposed with hardened nipples. Both women maintain their exact same identical original faces with all the exact same identical features. The man's face is also preserved exactly. Everything else stays the exact same!",
        "Triple Threat Oral": "The man from the photo reclines while three women from the photo surround his penis. The first woman from the photo has the penis fully buried in her mouth with zero shaft visible. The second woman from the photo licks and sucks one side of the base. The third woman from the photo licks and sucks the other side of the base. All three women are fully naked with breasts exposed. All three women maintain their exact same identical original faces with all the exact same identical features. The man's face is also preserved exactly. Everything else stays the exact same!",
        "Dual Penetration Bliss": "The man from the photo lies on his back. The first woman from the photo rides him facing camera with his penis fully buried inside her vagina, vulva stretched around the base with zero shaft visible. The second woman from the photo sits on his face with her vagina pressed against his mouth, his tongue deep inside her. Both women's breasts are fully exposed. Both women maintain their exact same identical original faces with all the exact same identical features, mouths open in ecstasy. The man's visible features are preserved exactly. Everything else stays the exact same!",
        "Sandwich Position": "The man from the photo stands between two women from the photo. The first woman from the photo is bent over in front of him with his penis fully buried in her vagina from behind, vulva gripping the base. The second woman from the photo kneels behind him with her tongue deep in his ass while reaching around to finger the first woman's clitoris. All participants are fully naked. Both women maintain their exact same identical original faces with all the exact same identical features. The man's face is preserved exactly. Everything else stays the exact same!",
        "Double Ride Front and Back": "The man from the photo sits on a chair. The first woman from the photo sits on his lap facing him with his penis completely buried in her vagina, zero shaft showing. The second woman from the photo sits on his face facing the first woman, his tongue fully inside her vagina. The two women kiss passionately while grinding. Both women's breasts are pressed together. Both women maintain their exact same identical original faces with all the exact same identical features. The man's visible features are preserved exactly. Everything else stays the exact same!",
        "Oral While Penetrating": "The man from the photo stands while the first woman from the photo is bent over in front of him with his penis fully buried deep in her ass, her hole stretched around the base with zero shaft visible. The second woman from the photo kneels beneath them licking the first woman's dripping vagina, tongue deep inside. Both women are fully naked with breasts exposed. Both women maintain their exact same identical original faces with all the exact same identical features. The man's face is preserved exactly. Everything else stays the exact same!",
        "Two Mouths One Vagina": "The first woman from the photo lies on her back with legs spread maximally. The man from the photo penetrates her vagina with his penis fully buried inside, zero shaft showing. The second woman from the photo positions her face close to the penetration, licking the first woman's clitoris and the base of the penis simultaneously. All participants are fully naked. Both women maintain their exact same identical original faces with all the exact same identical features. The man's face is preserved exactly. Everything else stays the exact same!",
        "Stacked Penetration": "Two women from the photo are stacked on top of each other on all fours, asses in the air. The man from the photo alternates penetrating both, currently his penis is fully buried in the top woman's vagina with zero shaft visible while his fingers are deep inside the bottom woman's vagina. Both women's faces are turned back looking at camera. Both women are fully naked with breasts hanging. Both women maintain their exact same identical original faces with all the exact same identical features. The man's face is preserved exactly. Everything else stays the exact same!",
        "Side by Side Service": "Two women from the photo lie side by side on their backs with legs spread wide. The man from the photo kneels between them with his penis fully buried in the first woman's vagina, zero shaft showing, while his fingers are deep inside the second woman's vagina. Both women reach across to touch each other's breasts. Both women are fully naked. Both women maintain their exact same identical original faces with all the exact same identical features, mouths open in pleasure. The man's face is preserved exactly. Everything else stays the exact same!",
        "Triple Connection": "Three women from the photo form a triangle. The man from the photo stands with his penis fully buried in the first woman's mouth, zero shaft visible. The first woman's face is between the second woman's legs with her tongue deep in the second woman's vagina. The second woman's face is between the third woman's legs with her tongue deep in the third woman's vagina. The third woman licks and fingers the first woman's vagina. All participants are fully naked. All three women maintain their exact same identical original faces with all the exact same identical features. The man's face is preserved exactly. Everything else stays the exact same!"
    }
